...
import "../../styles/toggleLightDark.scss";

const MySVG = (props) => (
   <svg viewBox='0 0 69.667 44' xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg' {...props}>
      <g transform='translate(3.5 3.5)' data-name='Component_15_1' id='Component_15_1'>
...
const ToggleLightDark = ({darkMode, setDarkMode}) => {
   ...
   return (
      <>
         <label id='theme-toggle-button' style={{zIndex: "100"}}>
            <input type='checkbox' id='toggle' checked={isChecked} onChange={handleChange} />
            <MySVG />
         </label>
      </>
   );
